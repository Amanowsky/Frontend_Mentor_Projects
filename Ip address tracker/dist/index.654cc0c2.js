...
})({"3GdcC":[function(require,module,exports) {
"use strict";
...
async function getLocation(getIp1) {
    var ip = getIp1;
    try {
        response = await axios.get("https://geo.ipify.org/api/v2/country?apiKey=at_Ra01PWZMXAn9vPlnTQTYZSjFkyz56&ipAddress=217.97.105.51");
    } catch (error) {
        console.log(error);
    }
...
},{"./../utils":"5By4s"}]},["3GdcC","8Zgej"], "8Zgej", "parcelRequirea27b")
