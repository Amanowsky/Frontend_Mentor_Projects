 ...
 */ !function(t, i) {
    "object" == typeof exports && "undefined" != typeof module ? i(exports) : "function" == typeof define && define.amd ? define([
        "exports"
    ], i) : i((t = "undefined" != typeof globalThis ? globalThis : t || self).leaflet = {});
}(this, function(t1) {
    "use strict";
    function l1(t) {
    ...
    function x(t, i, e) {
        if (!e || $ !== J) return $.call(window, a1(t, i));
        t.call(i);
    }
    function r1(t) {
        t && Q.call(window, t);
    ...
    function it() {}
    it.extend = function(t3) {
        function i2() {
            c1(this), this.initialize && this.initialize.apply(this, arguments), this.callInitHooks();
        }
        var e, n = i2.__super__ = this.prototype, o = R(n);
        for(e in (o.constructor = i2).prototype = o, this)Object.prototype.hasOwnProperty.call(this, e) && "prototype" !== e && "__super__" !== e && (i2[e] = this[e]);
        if (t3.statics && l1(i2, t3.statics), t3.includes) {
            var s = t3.includes;
        ...
        return l1(o, t3), delete o.statics, delete o.includes, o.options && (o.options = n.options ? R(n.options) : {}, l1(o.options, t3.options)), o._initHooks = [], o.callInitHooks = function() {
        ...
        return l1(this.prototype, t), t.options && (this.prototype.options = i, this.mergeOptions(t.options)), this;
    }, it.mergeOptions = function(t) {
        return l1(this.prototype.options, t), this;
    ...
    var i1 = {
        ...
        _off: function(t, i, e) {
            ...
            if (this._events && (n = this._events[t])) {
                if (1 === arguments.length) {
                    if (this._firingCount) for(o = 0, s = n.length; o < s; o++)n[o].fn = u1;
                    delete this._events[t];
                } else if (e === this && (e = void 0), "function" != typeof i) console.warn("wrong listener type: " + typeof i);
                else {
                    for(o = 0, s = n.length; o < s; o++){
                        var r = n[o];
                        if (r.ctx === e && r.fn === i) return this._firingCount && (r.fn = u1, this._events[t] = n = n.slice()), void n.splice(o, 1);
                    }
        ...
        addEventParent: function(t) {
            return this._eventParents = this._eventParents || {}, this._eventParents[h1(t)] = t, this;
        },
        removeEventParent: function(t) {
            return this._eventParents && delete this._eventParents[h1(t)], this;
        },
        _propagateEvent: function(t) {
            for(var i in this._eventParents)this._eventParents[i].fire(t.type, l1({
                layer: t.target,
                propagatedFrom: t.target
            }, t), !0);
        }
    }, et = (i1.addEventListener = i1.on, i1.removeEventListener = i1.clearAllEventListeners = i1.off, i1.addOneTimeEventListener = i1.once, i1.fireEvent = i1.fire, i1.hasEventListeners = i1.listens, it.extend(i1));
    function p1(t, i, e) {
    ...
    function _1(t, i, e) {
        return t instanceof p1 ? t : d1(t) ? new p1(t[0], t[1]) : null == t ? t : "object" == typeof t && "x" in t && "y" in t ? new p1(t.x, t.y) : new p1(t, i, e);
    }
    function m1(t, i) {
        if (t) for(var e = i ? [
            t,
    ...
    function f1(t, i) {
        return !t || t instanceof m1 ? t : new m1(t, i);
    }
    function s1(t, i) {
        if (t) for(var e = i ? [
            t,
    ...
    function g1(t, i) {
        return t instanceof s1 ? t : new s1(t, i);
    }
    function v1(t, i, e) {
    ...
    function w(t, i, e) {
        return t instanceof v1 ? t : d1(t) && "object" != typeof t[0] ? 3 === t.length ? new v1(t[0], t[1], t[2]) : 2 === t.length ? new v1(t[0], t[1]) : null : null == t ? t : "object" == typeof t && "lat" in t ? new v1(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : void 0 === i ? null : new v1(t, i, e);
    }
    p1.prototype = {
        clone: function() {
            return new p1(this.x, this.y);
        },
        add: function(t) {
            return this.clone()._add(_1(t));
        },
        _add: function(t) {
            return this.x += t.x, this.y += t.y, this;
        },
        subtract: function(t) {
            return this.clone()._subtract(_1(t));
        },
        ...
        scaleBy: function(t) {
            return new p1(this.x * t.x, this.y * t.y);
        },
        ...
        distanceTo: function(t) {
            var i = (t = _1(t)).x - this.x, t = t.y - this.y;
            return Math.sqrt(i * i + t * t);
        },
        equals: function(t) {
            return (t = _1(t)).x === this.x && t.y === this.y;
        },
        contains: function(t) {
            return t = _1(t), Math.abs(t.x) <= Math.abs(this.x) && Math.abs(t.y) <= Math.abs(this.y);
        },
        toString: function() {
            return "Point(" + e1(this.x) + ", " + e1(this.y) + ")";
        }
    }, m1.prototype = {
        extend: function(t) {
            return t = _1(t), this.min || this.max ? (this.min.x = Math.min(t.x, this.min.x), this.max.x = Math.max(t.x, this.max.x), this.min.y = Math.min(t.y, this.min.y), this.max.y = Math.max(t.y, this.max.y)) : (this.min = t.clone(), this.max = t.clone()), this;
        },
        getCenter: function(t) {
            return new p1((this.min.x + this.max.x) / 2, (this.min.y + this.max.y) / 2, t);
        },
        getBottomLeft: function() {
            return new p1(this.min.x, this.max.y);
        },
        getTopRight: function() {
            return new p1(this.max.x, this.min.y);
        },
        getTopLeft: function() {
            return this.min;
        },
        ...
        contains: function(t) {
            var i, e;
            return (t = ("number" == typeof t[0] || t instanceof p1 ? _1 : f1)(t)) instanceof m1 ? (i = t.min, e = t.max) : i = e = t, i.x >= this.min.x && e.x <= this.max.x && i.y >= this.min.y && e.y <= this.max.y;
        },
        intersects: function(t) {
            t = f1(t);
            var i = this.min, e = this.max, n = t.min, t = t.max, o = t.x >= i.x && n.x <= e.x, t = t.y >= i.y && n.y <= e.y;
            return o && t;
        },
        overlaps: function(t) {
            t = f1(t);
        ...
        extend: function(t) {
            ...
            if (t instanceof v1) e = i = t;
            else {
                if (!(t instanceof s1)) return t ? this.extend(w(t) || g1(t)) : this;
                if (i = t._southWest, e = t._northEast, !i || !e) return this;
            }
            return n || o ? (n.lat = Math.min(i.lat, n.lat), n.lng = Math.min(i.lng, n.lng), o.lat = Math.max(e.lat, o.lat), o.lng = Math.max(e.lng, o.lng)) : (this._southWest = new v1(i.lat, i.lng), this._northEast = new v1(e.lat, e.lng)), this;
        },
        pad: function(t) {
            var i = this._southWest, e = this._northEast, n = Math.abs(i.lat - e.lat) * t, t = Math.abs(i.lng - e.lng) * t;
            return new s1(new v1(i.lat - n, i.lng - t), new v1(e.lat + n, e.lng + t));
        },
        getCenter: function() {
            return new v1((this._southWest.lat + this._northEast.lat) / 2, (this._southWest.lng + this._northEast.lng) / 2);
        },
        ...
        getNorthWest: function() {
            return new v1(this.getNorth(), this.getWest());
        },
        getSouthEast: function() {
            return new v1(this.getSouth(), this.getEast());
        },
        getWest: function() {
        ...
        contains: function(t) {
            t = ("number" == typeof t[0] || t instanceof v1 || "lat" in t ? w : g1)(t);
            var i, e, n = this._southWest, o = this._northEast;
            return t instanceof s1 ? (i = t.getSouthWest(), e = t.getNorthEast()) : i = e = t, i.lat >= n.lat && e.lat <= o.lat && i.lng >= n.lng && e.lng <= o.lng;
        },
        intersects: function(t) {
            t = g1(t);
            var i = this._southWest, e = this._northEast, n = t.getSouthWest(), t = t.getNorthEast(), o = t.lat >= i.lat && n.lat <= e.lat, t = t.lng >= i.lng && n.lng <= e.lng;
            return o && t;
        },
        overlaps: function(t) {
            t = g1(t);
        ...
        equals: function(t, i) {
            return !!t && (t = g1(t), this._southWest.equals(t.getSouthWest(), i) && this._northEast.equals(t.getNorthEast(), i));
        },
        isValid: function() {
    ...
    var ot = {
        ...
        getProjectedBounds: function(t) {
            ...
            var i = this.projection.bounds, t = this.scale(t);
            return new m1(this.transformation.transform(i.min, t), this.transformation.transform(i.max, t));
        },
        infinite: (v1.prototype = {
            equals: function(t, i) {
                return !!t && (t = w(t), Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= (void 0 === i ? 1e-9 : i));
            },
            toString: function(t) {
                return "LatLng(" + e1(this.lat, t) + ", " + e1(this.lng, t) + ")";
            },
            distanceTo: function(t) {
            ...
            toBounds: function(t) {
                var t = 180 * t / 40075017, i = t / Math.cos(Math.PI / 180 * this.lat);
                return g1([
                    this.lat - t,
                    this.lng - i
                ], [
            ...
            clone: function() {
                return new v1(this.lat, this.lng, this.alt);
            }
        }, false),
        wrapLatLng: function(t) {
            var i = this.wrapLng ? H(t.lng, this.wrapLng, !0) : t.lng;
            return new v1(this.wrapLat ? H(t.lat, this.wrapLat, !0) : t.lat, i, t.alt);
        },
        wrapLatLngBounds: function(t) {
            var i = t.getCenter(), e = this.wrapLatLng(i), n = i.lat - e.lat, i = i.lng - e.lng;
            if (0 == n && 0 == i) return t;
            e = t.getSouthWest(), t = t.getNorthEast();
            return new s1(new v1(e.lat - n, e.lng - i), new v1(t.lat - n, t.lng - i));
        }
    }, st = l1({}, ot, {
        wrapLng: [
            -180,
        ...
        distance: function(t, i) {
            var e = Math.PI / 180, n = t.lat * e, o = i.lat * e, s = Math.sin((i.lat - t.lat) * e / 2), i = Math.sin((i.lng - t.lng) * e / 2), t = s * s + Math.cos(n) * Math.cos(o) * i * i, e = 2 * Math.atan2(Math.sqrt(t), Math.sqrt(1 - t));
            return this.R * e;
        }
    }), rt = 6378137, rt = {
        R: rt,
        ...
        project: function(t) {
            var i = Math.PI / 180, e = this.MAX_LATITUDE, e = Math.max(Math.min(e, t.lat), -e), e = Math.sin(e * i);
            return new p1(this.R * t.lng * i, this.R * Math.log((1 + e) / (1 - e)) / 2);
        },
        unproject: function(t) {
            var i = 180 / Math.PI;
            return new v1((2 * Math.atan(Math.exp(t.y / this.R)) - Math.PI / 2) * i, t.x * i / this.R);
        },
        bounds: new m1([
            -(rt = rt * Math.PI),
            -rt
    ...
    function at(t, i, e, n) {
        if (d1(t)) return this._a = t[0], this._b = t[1], this._c = t[2], void (this._d = t[3]);
    ...
    at.prototype = {
        ...
        untransform: function(t, i) {
            return new p1((t.x / (i = i || 1) - this._b) / this._a, (t.y / i - this._d) / this._c);
        }
    };
    var lt = l1({}, st, {
        code: "EPSG:3857",
    ...
    var _t = document.documentElement.style, pt = "ActiveXObject" in window, mt = pt && !document.addEventListener, n1 = "msLaunchUri" in navigator && !("documentMode" in document), ft = y1("webkit"), gt = y1("android"), vt = y1("android 2") || y1("android 3"), yt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), yt = gt && y1("Google") && yt < 537 && !("AudioNode" in window), xt = !!window.opera, wt = !n1 && y1("chrome"), Pt = y1("gecko") && !ft && !xt && !pt, bt = !wt && y1("safari"), Lt = y1("phantom"), o1 = "OTransition" in _t, Tt = 0 === navigator.platform.indexOf("Win"), zt = pt && "transition" in _t, Mt = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !vt, _t = "MozPerspective" in _t, Ct = !window.L_DISABLE_3D && (zt || Mt || _t) && !o1 && !Lt, Zt = "undefined" != typeof orientation || y1("mobile"), St = Zt && ft, kt = Zt && Mt, Et = !window.PointerEvent && window.MSPointerEvent, Bt = !(!window.PointerEvent && !Et), At = "ontouchstart" in window || !!window.TouchEvent, It = !window.L_NO_TOUCH && (At || Bt), Ot = Zt && xt, Rt = Zt && Pt, Nt = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI), Dt = function() {
        var t = !1;
        try {
            ...
            window.addEventListener("testPassiveEventSupport", u1, i), window.removeEventListener("testPassiveEventSupport", u1, i);
        } catch (t4) {}
        return t;
    ...
    var P = {
        ...
        vml: !Ht && function() {
            try {
                var t = document.createElement("div"), i = (t.innerHTML = '<v:shape adj="1"/>', t.firstChild);
        ...
        inlineSvg: Wt
    }, Ft = P.msPointer ? "MSPointerDown" : "pointerdown", Ut = P.msPointer ? "MSPointerMove" : "pointermove", Vt = P.msPointer ? "MSPointerUp" : "pointerup", qt = P.msPointer ? "MSPointerCancel" : "pointercancel", Gt = {
        touchstart: Ft,
        touchmove: Ut,
        touchend: Vt,
        touchcancel: qt
    ...
    var ei = 200;
    function ni(t5, e2) {
        t5.addEventListener("dblclick", e2);
        var n2, o = 0;
        function i3(t6) {
            var i4;
            1 !== t6.detail ? n2 = t6.detail : "mouse" === t6.pointerType || t6.sourceCapabilities && !t6.sourceCapabilities.firesTouchEvents || ((i4 = Date.now()) - o <= ei ? 2 === ++n2 && e2(function(t) {
                var i, e, n = {};
                for(e in t)i = t[e], n[e] = i && i.bind ? i.bind(t) : i;
                return (t = n).type = "dblclick", n.detail = 2, n.isTrusted = !1, n._simulated = !0, n;
            }(t6)) : n2 = 1, o = i4);
        }
        return t5.addEventListener("click", i3), {
            dblclick: e2,
            simDblclick: i3
        };
    }
    var oi, si, ri, ai, hi, li, ui = wi([
        "transform",
        "webkitTransform",
        "OTransform",
        "MozTransform",
    ...
    function bi(t) {
        return t._leaflet_pos || new p1(0, 0);
    }
    function Li() {
    ...
    function E(t8, i, e, n) {
        if (1 === arguments.length) Si(t8), delete t8[k];
        else if (i && "object" == typeof i) for(var o in i)Bi(t8, o, i[o], e);
        else if (i = F(i), 2 === arguments.length) Si(t8, function(t) {
            return -1 !== G(i, t);
        });
        else for(var s = 0, r = i.length; s < r; s++)Bi(t8, i[s], e, n);
        return this;
    }
    function Si(t, i) {
        for(var e in t[k]){
    ...
    function Ei(i, t9, e, n) {
        var o, s, r = t9 + h1(e) + (n ? "_" + h1(n) : "");
        i[k] && i[k][r] || (s = o = function(t) {
            return e.call(n || i, t || window.event);
        }, !P.touchNative && P.pointer && 0 === t9.indexOf("touch") ? o = Jt(i, t9, o) : P.touch && "dblclick" === t9 ? o = ni(i, o) : "addEventListener" in i ? "touchstart" === t9 || "touchmove" === t9 || "wheel" === t9 || "mousewheel" === t9 ? i.addEventListener(ki[t9] || t9, o, !!P.passiveEvents && {
            passive: !1
        }) : "mouseenter" === t9 || "mouseleave" === t9 ? i.addEventListener(ki[t9], o = function(t) {
            t = t || window.event, Hi(i, t) && s(t);
        }, !1) : i.addEventListener(t9, s, !1) : i.attachEvent("on" + t9, o), i[k] = i[k] || {}, i[k][r] = o);
    }
    ...
    function Ni(t, i) {
        if (!i) return new p1(t.clientX, t.clientY);
        var e = Zi(i), n = e.boundingClientRect;
        return new p1((t.clientX - n.left) / e.x - i.clientLeft, (t.clientY - n.top) / e.y - i.clientTop);
    }
    ...
    var mt = {
        ...
        _complete: function() {
            r1(this._animId), this._inProgress = !1, this.fire("end");
        },
        _easeOut: function(t) {
        ...
        initialize: function(t, i) {
            i = c1(this, i), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = !0, this._initContainer(t), this._initLayout(), this._onResize = a1(this._onResize, this), this._initEvents(), i.maxBounds && this.setMaxBounds(i.maxBounds), void 0 !== i.zoom && (this._zoom = this._limitZoom(i.zoom)), i.center && void 0 !== i.zoom && this.setView(w(i.center), i.zoom, {
                reset: !0
        ...
        setView: function(t, i, e) {
            if ((i = void 0 === i ? this._zoom : this._limitZoom(i), t = this._limitCenter(w(t), i, this.options.maxBounds), e = e || {}, this._stop(), this._loaded && !e.reset && !0 !== e) && (void 0 !== e.animate && (e.zoom = l1({
                animate: e.animate
            }, e.zoom), e.pan = l1({
                animate: e.animate,
                duration: e.duration
        ...
        setZoomAround: function(t, i, e) {
            var n = this.getZoomScale(i), o = this.getSize().divideBy(2), t = (t instanceof p1 ? t : this.latLngToContainerPoint(t)).subtract(o).multiplyBy(1 - 1 / n), n = this.containerPointToLatLng(o.add(t));
            return this.setView(n, i, {
                zoom: e
            });
        },
        _getBoundsCenterZoom: function(t, i) {
            i = i || {}, t = t.getBounds ? t.getBounds() : g1(t);
            var e = _1(i.paddingTopLeft || i.padding || [
                0,
                0
            ]), n = _1(i.paddingBottomRight || i.padding || [
                0,
                0
        ...
        fitBounds: function(t, i) {
            if (!(t = g1(t)).isValid()) throw new Error("Bounds are not valid.");
        ...
        panBy: function(t, i) {
            var e;
            return i = i || {}, (t = _1(t).round()).x || t.y ? (!0 === i.animate || this.getSize().contains(t) ? (this._panAnim || (this._panAnim = new Wi, this._panAnim.on({
        ...
        flyTo: function(n, o, t11) {
            if (!1 === (t11 = t11 || {}).animate || !P.any3d) return this.setView(n, o, t11);
            this._stop();
            var s = this.project(this.getCenter()), r = this.project(n), i5 = this.getSize(), a = this._zoom, h = (n = w(n), o = void 0 === o ? a : o, Math.max(i5.x, i5.y)), e3 = h * this.getZoomScale(a, o), l = r.distanceTo(s) || 1, u = 1.42, c = u * u;
            function d(t) {
                t = (e3 * e3 - h * h + (t ? -1 : 1) * c * c * l * l) / (2 * (t ? e3 : h) * c * l), t = Math.sqrt(t * t + 1) - t;
            ...
            var g = Date.now(), v = (d(1) - m) / u, y = t11.duration ? 1e3 * t11.duration : 1e3 * v * .8;
            return this._moveStart(!0, t11.noMoveStart), (function t() {
                var i = (Date.now() - g) / y, e = (1 - Math.pow(1 - i, 1.5)) * v;
        ...
        setMaxBounds: function(t) {
            return (t = g1(t)).isValid() ? (this.options.maxBounds && this.off("moveend", this._panInsideMaxBounds), this.options.maxBounds = t, this._loaded && this._panInsideMaxBounds(), this.on("moveend", this._panInsideMaxBounds)) : (this.options.maxBounds = null, this.off("moveend", this._panInsideMaxBounds));
        },
        ...
        panInsideBounds: function(t, i) {
            ...
            var e = this.getCenter(), t = this._limitCenter(e, this._zoom, g1(t));
            return e.equals(t) || this.panTo(t, i), this._enforcingBounds = !1, this;
        },
        panInside: function(t, i) {
            var e = _1((i = i || {}).paddingTopLeft || i.padding || [
                0,
                0
            ]), n = _1(i.paddingBottomRight || i.padding || [
                0,
                0
            ]), o = this.project(this.getCenter()), t = this.project(t), s = this.getPixelBounds(), e = f1([
                s.min.add(e),
                s.max.subtract(n)
            ]), s = e.getSize();
        ...
        invalidateSize: function(t) {
            ...
            var i = this.getSize(), e = (this._sizeChanged = !0, this._lastCenter = null, this.getSize()), n = i.divideBy(2).round(), o = e.divideBy(2).round(), n = n.subtract(o);
            return n.x || n.y ? (t.animate && t.pan ? this.panBy(n) : (t.pan && this._rawPanBy(n), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(a1(this.fire, this, "moveend"), 200)) : this.fire("moveend")), this.fire("resize", {
                oldSize: i,
                newSize: e
            })) : this;
        },
        ...
        locate: function(t) {
            ...
            var i = a1(this._handleGeolocationResponse, this), e = a1(this._handleGeolocationError, this);
        ...
        _handleGeolocationResponse: function(t) {
            if (this._container._leaflet_id) {
                var i, e, n = new v1(t.coords.latitude, t.coords.longitude), o = n.toBounds(2 * t.coords.accuracy), s = this._locateOptions, r = (s.setView && (i = this.getBoundsZoom(o), this.setView(n, s.maxZoom ? Math.min(i, s.maxZoom) : i)), {
                    latlng: n,
                    bounds: o,
        ...
        remove: function() {
            ...
            for(var t in void 0 !== this._locationWatchId && this.stopLocate(), this._stop(), T(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (r1(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload"), this._layers)this._layers[t].remove();
            for(t1 in this._panes)T(this._panes[t1]);
        ...
        getBounds: function() {
            ...
            return new s1(this.unproject(t.getBottomLeft()), this.unproject(t.getTopRight()));
        },
        getMinZoom: function() {
        ...
        getBoundsZoom: function(t, i, e) {
            ...
            var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), t = t.getSouthEast(), e = this.getSize().subtract(e), t = f1(this.project(t, n), this.project(r, n)).getSize(), r = P.any3d ? this.options.zoomSnap : 1, a = e.x / t.x, e = e.y / t.y, t = i ? Math.max(a, e) : Math.min(a, e), n = this.getScaleZoom(t, n);
            return r && (n = Math.round(n / (r / 100)) * (r / 100), n = i ? Math.ceil(n / r) * r : Math.floor(n / r) * r), Math.max(o, Math.min(s, n));
        },
        getSize: function() {
            return this._size && !this._sizeChanged || (this._size = new p1(this._container.clientWidth || 0, this._container.clientHeight || 0), this._sizeChanged = !1), this._size.clone();
        },
        getPixelBounds: function(t, i) {
            t = this._getTopLeftPoint(t, i);
            return new m1(t, t.add(this.getSize()));
        },
        ...
        getScaleZoom: function(t, i) {
            var e = this.options.crs, t = (i = void 0 === i ? this._zoom : i, e.zoom(t * e.scale(i)));
        ...
        unproject: function(t, i) {
            return i = void 0 === i ? this._zoom : i, this.options.crs.pointToLatLng(_1(t), i);
        },
        layerPointToLatLng: function(t) {
            t = _1(t).add(this.getPixelOrigin());
        ...
        wrapLatLngBounds: function(t) {
            return this.options.crs.wrapLatLngBounds(g1(t));
        },
        distance: function(t, i) {
            return this.options.crs.distance(w(t), w(i));
        },
        containerPointToLayerPoint: function(t) {
            return _1(t).subtract(this._getMapPanePos());
        },
        layerPointToContainerPoint: function(t) {
            return _1(t).add(this._getMapPanePos());
        },
        containerPointToLatLng: function(t) {
            t = this.containerPointToLayerPoint(_1(t));
        ...
        _initContainer: function(t) {
            ...
            S(t, "scroll", this._onScroll, this), this._containerId = h1(t);
        },
        _initLayout: function() {
            var t = this._container, i = (this._fadeAnimated = this.options.fadeAnimation && P.any3d, z(t, "leaflet-container" + (P.touch ? " leaflet-touch" : "") + (P.retina ? " leaflet-retina" : "") + (P.ielt9 ? " leaflet-oldie" : "") + (P.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : "")), pi(t, "position"));
            "absolute" !== i && "relative" !== i && "fixed" !== i && (t.style.position = "relative"), this._initPanes(), this._initControlPos && this._initControlPos();
        },
        _initPanes: function() {
            var t = this._panes = {};
            this._paneRenderers = {}, this._mapPane = this.createPane("mapPane", this._container), Z(this._mapPane, new p1(0, 0)), this.createPane("tilePane"), this.createPane("overlayPane"), this.createPane("shadowPane"), this.createPane("markerPane"), this.createPane("tooltipPane"), this.createPane("popupPane"), this.options.markerZoomAnimation || (z(t.markerPane, "leaflet-zoom-hide"), z(t.shadowPane, "leaflet-zoom-hide"));
        },
        _resetView: function(t, i) {
            Z(this._mapPane, new p1(0, 0));
            var e = !this._loaded, n = (this._loaded = !0, i = this._limitZoom(i), this.fire("viewprereset"), this._zoom !== i);
        ...
        _stop: function() {
            return r1(this._flyToFrame), this._panAnim && this._panAnim.stop(), this;
        },
        ...
        _initEvents: function(t) {
            this._targets = {};
            var i = t ? E : S;
            i((this._targets[h1(this._container)] = this)._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress keydown keyup", this._handleDOMEvent, this), this.options.trackResize && i(window, "resize", this._onResize, this), P.any3d && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd);
        },
        _onResize: function() {
            r1(this._resizeRequest), this._resizeRequest = x(function() {
                this.invalidateSize({
                    debounceMoveend: !0
                });
            }, this);
        ...
        _findEventTargets: function(t, i) {
            for(var e, n = [], o = "mouseout" === i || "mouseover" === i, s = t.target || t.srcElement, r = !1; s;){
                if ((e = this._targets[h1(s)]) && ("click" === i || "preclick" === i) && this._draggableMoved(e)) {
                    r = !0;
                    break;
                }
                if (e && e.listens(i, !0)) {
            ...
            return n = n.length || r || o || !this.listens(i, !0) ? n : [
                this
            ];
        },
        ...
        _fireDOMEvent: function(t, i, e) {
            "click" === t.type && ((a = l1({}, t)).type = "preclick", this._fireDOMEvent(a, a.type, e));
        ...
        _getMapPanePos: function() {
            return bi(this._mapPane) || new p1(0, 0);
        },
        _moved: function() {
            var t = this._getMapPanePos();
            return t && !t.equals([
        ...
        _limitCenter: function(t, i, e) {
            if (!e) return t;
            var n = this.project(t, i), o = this.getSize().divideBy(2), o = new m1(n.subtract(o), n.add(o)), o = this._getBoundsOffset(o, e, i);
            return o.round().equals([
                0,
                0
            ]) ? t : this.unproject(n.add(o), i);
        },
        _limitOffset: function(t, i) {
            if (!i) return t;
            var e = this.getPixelBounds(), e = new m1(e.min.add(t), e.max.add(t));
            return t.add(this._getBoundsOffset(e, i));
        },
        _getBoundsOffset: function(t, i, e) {
            i = f1(this.project(i.getNorthEast(), e), this.project(i.getSouthWest(), e)), e = i.min.subtract(t.min), i = i.max.subtract(t.max);
            return new p1(this._rebound(e.x, -i.x), this._rebound(e.y, -i.y));
        },
        ...
        _createAnimProxy: function() {
            var t13 = this._proxy = b("div", "leaflet-proxy leaflet-zoom-animated");
            this._panes.mapPane.appendChild(t13), this.on("zoomanim", function(t) {
                var i = ui, e = this._proxy.style[i];
        ...
        _tryAnimatedZoom: function(t, i, e) {
            ...
            var n = this.getZoomScale(i), n = this._getCenterOffset(t)._divideBy(1 - 1 / n);
        ...
        _animateZoom: function(t, i, e, n) {
            this._mapPane && (e && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = i, z(this._mapPane, "leaflet-zoom-anim")), this.fire("zoomanim", {
                ...
                zoom: i,
                noUpdate: n
            }), this._tempFireZoomEvent || (this._tempFireZoomEvent = this._zoom !== this._animateToZoom), this._move(this._animateToCenter, this._animateToZoom, void 0, !0), setTimeout(a1(this._onZoomTransitionEnd, this), 250));
        },
    ...
    var Ui, I = it.extend({
        ...
        addTo: function(t) {
            ...
            var i = this._container = this.onAdd(t), e = this.getPosition(), t = t._controlCorners[e];
        ...
        _initControlPos: function() {
            var e = this._controlCorners = {}, n = "leaflet-", o = this._controlContainer = b("div", n + "control-container", this._container);
            function t14(t, i) {
                e[t + i] = b("div", n + t + " " + n + i, o);
            }
            t14("top", "left"), t14("top", "right"), t14("bottom", "left"), t14("bottom", "right");
        },
        ...
        initialize: function(t, i, e) {
            for(var n in c1(this, e), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, this._handlingClick = !1, t)this._addLayer(t[n], n);
        ...
        _initLayout: function() {
            var t = "leaflet-control-layers", i = this._container = b("div", t), e = this.options.collapsed, n = (i.setAttribute("aria-haspopup", !0), Oi(i), Ii(i), this._section = b("section", t + "-list")), o = (e && (this._map.on("click", this.collapse, this), S(i, {
                mouseenter: function() {
        ...
        _getLayer: function(t) {
            for(var i = 0; i < this._layers.length; i++)if (this._layers[i] && h1(this._layers[i].layer) === t) return this._layers[i];
        },
        _addLayer: function(t15, i6, e) {
            this._map && t15.on("add remove", this._onLayerChange, this), this._layers.push({
                layer: t15,
                name: i6,
                overlay: e
            }), this.options.sortLayers && this._layers.sort(a1(function(t, i) {
                return this.options.sortFunction(t.layer, i.layer, t.name, i.name);
            }, this)), this.options.autoZIndex && t15.setZIndex && (this._lastZIndex++, t15.setZIndex(this._lastZIndex)), this._expandIfNotCollapsed();
        },
        _update: function() {
        ...
        _onLayerChange: function(t) {
            ...
            var i = this._getLayer(h1(t.target)), t = i.overlay ? "add" === t.type ? "overlayadd" : "overlayremove" : "add" === t.type ? "baselayerchange" : null;
        ...
        _addItem: function(t) {
            var i, e = document.createElement("label"), n = this._map.hasLayer(t.layer), n = (t.overlay ? ((i = document.createElement("input")).type = "checkbox", i.className = "leaflet-control-layers-selector", i.defaultChecked = n) : i = this._createRadioElement("leaflet-base-layers_" + h1(this), n), this._layerControlInputs.push(i), i.layerId = h1(t.layer), S(i, "click", this._onInputClick, this), document.createElement("span")), o = (n.innerHTML = " " + t.name, document.createElement("span"));
        ...
        onAdd: function(t) {
            var i = "leaflet-control-zoom", e = b("div", i + " leaflet-bar"), n = this.options;
        ...
        onAdd: function(t) {
            var i = "leaflet-control-scale", e = b("div", i), n = this.options;
        ...
        _update: function() {
            var t = this._map, i = t.getSize().y / 2, t = t.distance(t.containerPointToLatLng([
                0,
                i
        ...
        _getRoundNum: function(t) {
            var i = Math.pow(10, (Math.floor(t) + "").length - 1), t = t / i;
        ...
        initialize: function(t, i, e, n) {
            c1(this, n), this._element = t, this._dragStartTarget = i || t, this._preventOutline = e;
        },
        enable: function() {
        ...
        _onDown: function(t) {
            var i, e;
            this._enabled && (this._moved = !1, vi(this._element, "leaflet-zoom-anim") || (t.touches && 1 !== t.touches.length ? Xi._dragging === this && this.finishDrag() : Xi._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((Xi._dragging = this)._preventOutline && zi(this._element), Li(), ri(), this._moving || (this.fire("down"), e = t.touches ? t.touches[0] : t, i = Ci(this._element), this._startPoint = new p1(e.clientX, e.clientY), this._startPos = bi(this._element), this._parentScale = Zi(i), e = "mousedown" === t.type, S(document, e ? "mousemove" : "touchmove", this._onMove, this), S(document, e ? "mouseup" : "touchend touchcancel", this._onUp, this)))));
        },
        _onMove: function(t) {
            var i;
            this._enabled && (t.touches && 1 < t.touches.length ? this._moved = !0 : !(i = new p1((i = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX, i.clientY)._subtract(this._startPoint)).x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, B(t), this._moved || (this.fire("dragstart"), this._moved = !0, z(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), z(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = !0, this._lastEvent = t, this._updatePosition()));
        },
    ...
    function Ji(t16, i7) {
        if (!i7 || !t16.length) return t16.slice();
        i7 *= i7;
        return t16 = function(t17, i8) {
            var e4 = t17.length, n3 = new (typeof Uint8Array != "undefined" ? Uint8Array : Array)(e4);
            n3[0] = n3[e4 - 1] = 1, function t(i, e, n, o, s) {
                var r, a, h, l = 0;
                for(a = o + 1; a <= s - 1; a++)h = ee(i[a], i[o], i[s], !0), l < h && (r = a, l = h);
                n < l && (e[r] = 1, t(i, e, n, o, r), t(i, e, n, r, s));
            }(t17, n3, i8, 0, e4 - 1);
            var o2, s2 = [];
            for(o2 = 0; o2 < e4; o2++)n3[o2] && s2.push(t17[o2]);
            return s2;
        }(t16 = function(t18, i9) {
            for(var e5 = [
                t18[0]
            ], n = 1, o = 0, s = t18.length; n < s; n++)(function(t, i) {
                var e = i.x - t.x, i = i.y - t.y;
                return e * e + i * i;
            })(t18[n], t18[o]) > i9 && (e5.push(t18[n]), o = n);
            o < s - 1 && e5.push(t18[s - 1]);
            return e5;
        }(t16, i7), i7);
    }
    function $i(t, i, e) {
    ...
    function te(t, i, e, n, o) {
        ...
        return 8 & e ? (s = t.x + a * (n.y - t.y) / i, r = n.y) : 4 & e ? (s = t.x + a * (h.y - t.y) / i, r = h.y) : 2 & e ? (s = n.x, r = t.y + i * (n.x - t.x) / a) : 1 & e && (s = h.x, r = t.y + i * (h.x - t.x) / a), new p1(s, r, o);
    }
    function ie(t, i) {
        var e = 0;
    ...
    function ee(t, i, e, n) {
        var o = i.x, i = i.y, s = e.x - o, r = e.y - i, a = s * s + r * r;
        return 0 < a && (1 < (a = ((t.x - o) * s + (t.y - i) * r) / a) ? (o = e.x, i = e.y) : 0 < a && (o += s * a, i += r * a)), s = t.x - o, r = t.y - i, n ? s * s + r * r : new p1(o, i);
    }
    function ne(t) {
        return !d1(t[0]) || "object" != typeof t[0][0] && void 0 !== t[0][0];
    }
    function oe(t) {
    ...
    function se(t, i, e) {
        for(var n, o, s, r, a, h, l, u = [
            ...
            2,
            8
        ], c = 0, d = t.length; c < d; c++)t[c]._code = ie(t[c], i);
        for(s = 0; s < 4; s++){
    ...
    var vt = {
        ...
        project: function(t) {
            return new p1(t.lng, t.lat);
        },
        unproject: function(t) {
            return new v1(t.y, t.x);
        },
        bounds: new m1([
            -180,
            -90
        ...
        project: function(t) {
            var i = Math.PI / 180, e = this.R, n = t.lat * i, o = this.R_MINOR / e, o = Math.sqrt(1 - o * o), s = o * Math.sin(n), s = Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - s) / (1 + s), o / 2), n = -e * Math.log(Math.max(s, 1e-10));
            return new p1(t.lng * i * e, n);
        },
        unproject: function(t) {
        ...
        distance: function(t, i) {
            var e = i.lng - t.lng, i = i.lat - t.lat;
            return Math.sqrt(e * e + i * i);
        },
        infinite: !0
    }), o1 = (ot.Earth = st, ot.EPSG3395 = bt, ot.EPSG3857 = lt, ot.EPSG900913 = ut, ot.EPSG4326 = re, ot.Simple = Lt, et.extend({
        options: {
            pane: "overlayPane",
            attribution: null,
        ...
        addInteractiveTarget: function(t) {
            return this._map._targets[h1(t)] = this;
        },
        removeInteractiveTarget: function(t) {
            return delete this._map._targets[h1(t)], this;
        },
        ...
        _addLayers: function(t) {
            for(var i = 0, e = (t = t ? d1(t) ? t : [
                t
            ] : []).length; i < e; i++)this.addLayer(t[i]);
        },
        _addZoomLimit: function(t) {
            isNaN(t.options.maxZoom) && isNaN(t.options.minZoom) || (this._zoomBoundLayers[h1(t)] = t, this._updateZoomLevels());
        },
        ...
        initialize: function(t, i) {
            var e, n;
            if (c1(this, i), this._layers = {}, t) for(e = 0, n = t.length; e < n; e++)this.addLayer(t[e]);
        },
        addLayer: function(t) {
        ...
        _setIconStyles: function(t, i) {
            var e = this.options, n = e[i + "Size"], n = _1(n = "number" == typeof n ? [
                n,
                n
            ] : n), o = _1("shadow" === i && e.shadowAnchor || e.iconAnchor || n && n.divideBy(2, !0));
    ...
    var ue = le.extend({
        ...
        _stripUrl: function(t19) {
            function i10(t, i, e) {
                return (i = i.exec(t)) && i[e];
            }
            return (t19 = i10(t19, /^url\((['"])?(.+)\1\)$/, 2)) && i10(t19, /^(.*)marker-icon\.png$/, 1);
        },
        _detectIconPath: function() {
            var t = b("div", "leaflet-default-icon-path", document.body), i = pi(t, "background-image") || pi(t, "backgroundImage");
            if (document.body.removeChild(t), i = this._stripUrl(i)) return i;
            t = document.querySelector('link[href$="leaflet.css"]');
            return t ? t.href.substring(0, t.href.length - 11 - 1) : "";
        }
    }), ce = n1.extend({
        initialize: function(t) {
            this._marker = t;
        ...
        _adjustPan: function(t) {
            var i = this._marker, e = i._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = bi(i._icon), r = e.getPixelBounds(), a = e.getPixelOrigin(), a = f1(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o));
            a.contains(s) || (o = _1((Math.max(a.max.x, s.x) - a.max.x) / (r.max.x - a.max.x) - (Math.min(a.min.x, s.x) - a.min.x) / (r.min.x - a.min.x), (Math.max(a.max.y, s.y) - a.max.y) / (r.max.y - a.max.y) - (Math.min(a.min.y, s.y) - a.min.y) / (r.min.y - a.min.y)).multiplyBy(n), e.panBy(o, {
                animate: !1
        ...
        _onPreDrag: function(t) {
            this._marker.options.autoPan && (r1(this._panRequest), this._panRequest = x(this._adjustPan.bind(this, t)));
        },
        _onDrag: function(t) {
            var i = this._marker, e = i._shadow, n = bi(i._icon), o = i._map.layerPointToLatLng(n);
            e && Z(e, n), i._latlng = o, t.latlng = o, t.oldLatLng = this._oldLatLng, i.fire("move", t).fire("drag", t);
        },
        _onDragEnd: function(t) {
            r1(this._panRequest), delete this._oldLatLng, this._marker.fire("moveend").fire("dragend", t);
        }
    }), de = o1.extend({
        options: {
            icon: new ue,
        ...
        _initIcon: function() {
            var t = this.options, i = "leaflet-zoom-" + (this._zoomAnimated ? "animated" : "hide"), e = t.icon.createIcon(this._icon), n = !1, e = (e !== this._icon && (this._icon && this._removeIcon(), n = !0, t.title && (e.title = t.title), "IMG" === e.tagName && (e.alt = t.alt || "")), z(e, i), t.keyboard && (e.tabIndex = "0", e.setAttribute("role", "button")), this._icon = e, t.riseOnHover && this.on({
                mouseover: this._bringToFront,
                mouseout: this._resetZIndex
            }), this.options.autoPanOnFocus && S(e, "focus", this._panOnFocus, this), t.icon.createShadow(this._shadow)), o = !1;
        ...
        _panOnFocus: function() {
            var t, i, e = this._map;
            e && (t = (i = this.options.icon.options).iconSize ? _1(i.iconSize) : _1(0, 0), i = i.iconAnchor ? _1(i.iconAnchor) : _1(0, 0), e.panInside(this._latlng, {
                paddingTopLeft: i,
    ...
    var _e = o1.extend({
        ...
        setStyle: function(t) {
            return c1(this, t), this._renderer && (this._renderer._updateStyle(this), this.options.stroke && t && Object.prototype.hasOwnProperty.call(t, "weight") && this._updateBounds()), this;
        },
        bringToFront: function() {
        ...
        initialize: function(t, i) {
            c1(this, i), this._latlng = w(t), this._radius = this.options.radius;
        },
        setLatLng: function(t) {
            var i = this._latlng;
        ...
        _updateBounds: function() {
            var t = this._radius, i = this._radiusY || t, e = this._clickTolerance(), t = [
                t + e,
                i + e
            ];
            this._pxBounds = new m1(this._point.subtract(t), this._point.add(t));
        },
        _update: function() {
    ...
    var me = pe.extend({
        initialize: function(t, i, e) {
            if (c1(this, i = "number" == typeof i ? l1({}, e, {
                radius: i
        ...
        getBounds: function() {
            ...
            return new s1(this._map.layerPointToLatLng(this._point.subtract(t)), this._map.layerPointToLatLng(this._point.add(t)));
        },
        ...
        _project: function() {
            ...
            h.distance === st.distance ? (n = Math.PI / 180, o = this._mRadius / st.R / n, t = a.project([
                ...
                r - o,
                s
            ]), i = t.add(i).divideBy(2), e = a.unproject(i).lat, n = Math.acos((Math.cos(o * n) - Math.sin(r * n) * Math.sin(e * n)) / (Math.cos(r * n) * Math.cos(e * n))) / n, !isNaN(n) && 0 !== n || (n = o / Math.cos(Math.PI / 180 * r)), this._point = i.subtract(a.getPixelOrigin()), this._radius = isNaN(n) ? 0 : i.x - a.project([
                e,
                s - n
            ]).x, this._radiusY = i.y - t.y) : (o = h.unproject(h.project(this._latlng).subtract([
                this._mRadius,
                0
    ...
    var fe = _e.extend({
        ...
        getCenter: function() {
            ...
            for(e = t = 0; t < a - 1; t++)if (n = r[t], o = r[t + 1], i < (e += s = n.distanceTo(o))) return this._map.layerPointToLatLng([
                o.x - (s = (e - i) / s) * (o.x - n.x),
                o.y - s * (o.y - n.y)
            ]);
        },
        ...
        _setLatLngs: function(t) {
            this._bounds = new s1, this._latlngs = this._convertLatLngs(t);
        },
        ...
        _updateBounds: function() {
            var t = this._clickTolerance(), t = new p1(t, t);
            this._rawPxBounds && (this._pxBounds = new m1([
                this._rawPxBounds.min.subtract(t),
                this._rawPxBounds.max.add(t)
            ]));
        },
        _projectLatlngs: function(t, i, e) {
            var n, o, s = t[0] instanceof v1, r = t.length;
            if (s) {
        ...
        _clipPoints: function() {
            ...
            if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
                ...
                else for(var i, e, n, o, s = this._parts, r = 0, a = 0, h = this._rings.length; r < h; r++)for(i = 0, e = (o = this._rings[r]).length; i < e - 1; i++)(n = Qi(o[i], o[i + 1], t, i, !0)) && (s[a] = s[a] || [], s[a].push(n[0]), n[1] === o[i + 1] && i !== e - 2 || (s[a].push(n[1]), a++));
            }
        },
    ...
    var ge = fe.extend({
        ...
        _convertLatLngs: function(t) {
            var t = fe.prototype._convertLatLngs.call(this, t), i = t.length;
            return 2 <= i && t[0] instanceof v1 && t[0].equals(t[i - 1]) && t.pop(), t;
        },
        _setLatLngs: function(t) {
            fe.prototype._setLatLngs.call(this, t), ne(this._latlngs) && (this._latlngs = [
                this._latlngs
            ]);
        },
        _defaultShape: function() {
        ...
        _clipPoints: function() {
            var t = this._renderer._bounds, i = this.options.weight, i = new p1(i, i), t = new m1(t.min.subtract(i), t.max.add(i));
            if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
                if (this.options.noClip) this._parts = this._rings;
    ...
    var ve = he.extend({
        initialize: function(t, i) {
            c1(this, i), this._layers = {}, t && this.addData(t);
        },
        addData: function(t) {
            var i, e, n, o = d1(t) ? t : t.features;
            if (o) {
        ...
        resetStyle: function(t) {
            return void 0 === t ? this.eachLayer(this.resetStyle, this) : (t.options = l1({}, t.defaultOptions), this._setLayerStyle(t, this.options.style), this);
        },
        setStyle: function(i) {
    ...
    de.include(Tt), me.include(Tt), pe.include(Tt), fe.include({
        ...
        toGeoJSON: function(t) {
            var i = !ne(this._latlngs), e = i && !ne(this._latlngs[0]), t = Le(this._latlngs, e ? 2 : i ? 1 : 0, !0, t);
            return Te(this, {
        ...
        toGeoJSON: function(i) {
            var t20 = this.feature && this.feature.geometry && this.feature.geometry.type;
            if ("MultiPoint" === t20) return this.toMultiPoint(i);
            var e = "GeometryCollection" === t20, n = [];
            return this.eachLayer(function(t) {
    ...
    var zt = Me, Ce = o1.extend({
        ...
        initialize: function(t, i, e) {
            this._url = t, this._bounds = g1(i), c1(this, e);
        },
        onAdd: function() {
        ...
        setBounds: function(t) {
            return this._bounds = g1(t), this._map && this._reset(), this;
        },
        getEvents: function() {
            var t = {
                zoom: this._reset,
        ...
        _initImage: function() {
            var t = "IMG" === this._url.tagName, i = this._image = t ? this._url : b("img");
            z(i, "leaflet-image-layer"), this._zoomAnimated && z(i, "leaflet-zoom-animated"), this.options.className && z(i, this.options.className), i.onselectstart = u1, i.onmousemove = u1, i.onload = a1(this.fire, this, "load"), i.onerror = a1(this._overlayOnError, this, "error"), !this.options.crossOrigin && "" !== this.options.crossOrigin || (i.crossOrigin = !0 === this.options.crossOrigin ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t ? this._url = i.src : (i.src = this._url, i.alt = this.options.alt);
        },
        _animateZoom: function(t) {
            var i = this._map.getZoomScale(t.zoom), t = this._map._latLngBoundsToNewLayerBounds(this._bounds, t.zoom, t.center).min;
            Pi(this._image, t, i);
        },
        _reset: function() {
            var t = this._image, i = new m1(this._map.latLngToLayerPoint(this._bounds.getNorthWest()), this._map.latLngToLayerPoint(this._bounds.getSouthEast())), e = i.getSize();
        ...
        _initImage: function() {
            var t = "VIDEO" === this._url.tagName, i = this._image = t ? this._url : b("video");
            if (z(i, "leaflet-image-layer"), this._zoomAnimated && z(i, "leaflet-zoom-animated"), this.options.className && z(i, this.options.className), i.onselectstart = u1, i.onmousemove = u1, i.onloadeddata = a1(this.fire, this, "load"), t) {
                for(var e = i.getElementsByTagName("source"), n = [], o = 0; o < e.length; o++)n.push(e[o].src);
                this._url = 0 < e.length ? n : [
                    i.src
                ];
            } else {
                d1(this._url) || (this._url = [
                    this._url
                ]), !this.options.keepAspectRatio && Object.prototype.hasOwnProperty.call(i.style, "objectFit") && (i.style.objectFit = "fill"), i.autoplay = !!this.options.autoplay, i.loop = !!this.options.loop, i.muted = !!this.options.muted, i.playsInline = !!this.options.playsInline;
    ...
    var Se = Ce.extend({
        _initImage: function() {
            ...
            z(t, "leaflet-image-layer"), this._zoomAnimated && z(t, "leaflet-zoom-animated"), this.options.className && z(t, this.options.className), t.onselectstart = u1, t.onmousemove = u1;
        }
    });
    var O = o1.extend({
        options: {
        ...
        onRemove: function(t) {
            t._fadeAnimated ? (C(this._container, 0), this._removeTimeout = setTimeout(a1(T, void 0, this._container), 200)) : T(this._container), this.options.interactive && (M(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
        },
        getLatLng: function() {
            return this._latlng;
        },
        ...
        _updatePosition: function() {
            var t, i, e;
            this._map && (i = this._map.latLngToLayerPoint(this._latlng), t = _1(this.options.offset), e = this._getAnchor(), this._zoomAnimated ? Z(this._container, i.add(e)) : t = t.add(i).add(e), i = this._containerBottom = -t.y, e = this._containerLeft = -Math.round(this._containerWidth / 2) + t.x, this._container.style.bottom = i + "px", this._container.style.left = e + "px");
        },
        _getAnchor: function() {
            return [
                0,
        ...
        _initOverlay: function(t, i, e, n) {
            var o = e;
            return o instanceof t ? (c1(o, n), o._source = this) : (o = i && !n ? i : new t(n, this)).setContent(e), o;
        }
    }), O.extend({
        options: {
            pane: "popupPane",
        ...
        _initLayout: function() {
            var t = "leaflet-popup", i = this._container = b("div", t + " " + (this.options.className || "") + " leaflet-zoom-animated"), e = this._wrapper = b("div", t + "-content-wrapper", i);
        ...
        _updateLayout: function() {
            var t = this._contentNode, i = t.style, e = (i.width = "", i.whiteSpace = "nowrap", t.offsetWidth), e = Math.min(e, this.options.maxWidth), e = (e = Math.max(e, this.options.minWidth), i.width = e + 1 + "px", i.whiteSpace = "", i.height = "", t.offsetHeight), n = this.options.maxHeight, o = "leaflet-popup-scrolled";
            n && n < e ? (i.height = n + "px", z(t, o)) : M(t, o), this._containerWidth = this._container.offsetWidth;
        },
        _animateZoom: function(t) {
            var t = this._map._latLngToNewLayerPoint(this._latlng, t.zoom, t.center), i = this._getAnchor();
            Z(this._container, t.add(i));
        },
        _adjustPan: function(t) {
            var i, e, n, o, s, r, a, h;
            this.options.autoPan && (this._map._panAnim && this._map._panAnim.stop(), i = this._map, e = parseInt(pi(this._container, "marginBottom"), 10) || 0, e = this._container.offsetHeight + e, h = this._containerWidth, (n = new p1(this._containerLeft, -e - this._containerBottom))._add(bi(this._container)), n = i.layerPointToContainerPoint(n), s = _1(this.options.autoPanPadding), o = _1(this.options.autoPanPaddingTopLeft || s), s = _1(this.options.autoPanPaddingBottomRight || s), r = i.getSize(), a = 0, n.x + h + s.x > r.x && (a = n.x + h - r.x + s.x), n.x - a - o.x < (h = 0) && (a = n.x - o.x), n.y + e + s.y > r.y && (h = n.y + e - r.y + s.y), n.y - h - o.y < 0 && (h = n.y - o.y), (a || h) && i.fire("autopanstart").panBy([
                a,
                h
            ], {
        ...
        _getAnchor: function() {
            return _1(this._source && this._source._getPopupAnchor ? this._source._getPopupAnchor() : [
                0,
                0
            ]);
        }
        ...
        _setPosition: function(t) {
            var i, e = this._map, n = this._container, o = e.latLngToContainerPoint(e.getCenter()), e = e.layerPointToContainerPoint(t), s = this.options.direction, r = n.offsetWidth, a = n.offsetHeight, h = _1(this.options.offset), l = this._getAnchor(), e = "top" === s ? (i = r / 2, a) : "bottom" === s ? (i = r / 2, 0) : (i = "center" === s ? r / 2 : "right" === s ? 0 : "left" === s ? r : e.x < o.x ? (s = "right", 0) : (s = "left", r + 2 * (h.x + l.x)), a / 2);
            t = t.subtract(_1(i, e, !0)).add(h).add(l), M(n, "leaflet-tooltip-right"), M(n, "leaflet-tooltip-left"), M(n, "leaflet-tooltip-top"), M(n, "leaflet-tooltip-bottom"), z(n, "leaflet-tooltip-" + s), Z(n, t);
        },
        _updatePosition: function() {
        ...
        _getAnchor: function() {
            return _1(this._source && this._source._getTooltipAnchor && !this.options.sticky ? this._source._getTooltipAnchor() : [
                0,
                0
            ]);
        }
        ...
        createIcon: function(t) {
            var t = t && "DIV" === t.tagName ? t : document.createElement("div"), i = this.options;
            return i.html instanceof Element ? (mi(t), t.appendChild(i.html)) : t.innerHTML = !1 !== i.html ? i.html : "", i.bgPos && (i = _1(i.bgPos), t.style.backgroundPosition = -i.x + "px " + -i.y + "px"), this._setIconStyles(t, "icon"), t;
        },
    ...
    var Ae = o1.extend({
        ...
        getTileSize: function() {
            ...
            return t instanceof p1 ? t : new p1(t, t);
        },
        _updateZIndex: function() {
        ...
        _updateOpacity: function() {
            if (this._map && !P.ielt9) {
                ...
                n && !this._noPrune && this._pruneTiles(), e && (r1(this._fadeFrame), this._fadeFrame = x(this._updateOpacity, this));
            }
        },
        _onOpaqueTile: u1,
        ...
        _updateLevels: function() {
            ...
            if (void 0 !== t) {
                ...
                return n || ((n = this._levels[t] = {}).el = b("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = i, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), u1(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n;
            }
        },
        _onUpdateLevel: u1,
        _onRemoveLevel: u1,
        ...
        _retainParent: function(t, i, e, n) {
            var t = Math.floor(t / 2), i = Math.floor(i / 2), e = e - 1, o = new p1(+t, +i), o = (o.z = e, this._tileCoordsToKey(o)), o = this._tiles[o];
        ...
        _retainChildren: function(t, i, e, n) {
            for(var o = 2 * t; o < 2 * t + 2; o++)for(var s = 2 * i; s < 2 * i + 2; s++){
                var r = new p1(o, s), r = (r.z = e + 1, this._tileCoordsToKey(r)), r = this._tiles[r];
        ...
        _setZoomTransform: function(t, i, e) {
            var n = this._map.getZoomScale(e, t.zoom), i = t.origin.multiplyBy(n).subtract(this._map._getNewPixelOrigin(i, e)).round();
        ...
        _getTiledPixelBounds: function(t) {
            var i = this._map, e = i._animatingZoom ? Math.max(i._animateToZoom, i.getZoom()) : i.getZoom(), e = i.getZoomScale(e, this._tileZoom), t = i.project(t, this._tileZoom).floor(), i = i.getSize().divideBy(2 * e);
            return new m1(t.subtract(i), t.add(i));
        },
        _update: function(t21) {
            var i11 = this._map;
            if (i11) {
                var e = this._clampZoom(i11.getZoom());
                if (void 0 === t21 && (t21 = i11.getCenter()), void 0 !== this._tileZoom) {
                    var n, i11 = this._getTiledPixelBounds(t21), o = this._pxBoundsToTileRange(i11), s = o.getCenter(), r = [], i11 = this.options.keepBuffer, a = new m1(o.getBottomLeft().subtract([
                        i11,
                        -i11
                    ]), o.getTopRight().add([
                        i11,
                    ...
                    for(n in this._tiles){
                        ...
                        h.z === this._tileZoom && a.contains(new p1(h.x, h.y)) || (this._tiles[n].current = !1);
                    }
                    if (1 < Math.abs(e - this._tileZoom)) this._setView(t21, e);
                    else {
        ...
        _isValidTile: function(t) {
            ...
            return g1(this.options.bounds).overlaps(i);
        },
        _keyToBounds: function(t) {
            return this._tileCoordsToBounds(this._keyToTileCoords(t));
        },
        _tileCoordsToNwSe: function(t) {
            var i = this._map, e = this.getTileSize(), n = t.scaleBy(e), e = n.add(e);
            return [
                i.unproject(n, t.z),
                i.unproject(e, t.z)
            ];
        ...
        _tileCoordsToBounds: function(t) {
            t = this._tileCoordsToNwSe(t), t = new s1(t[0], t[1]);
        ...
        _keyToTileCoords: function(t) {
            var t = t.split(":"), i = new p1(+t[0], +t[1]);
            return i.z = +t[2], i;
        },
        ...
        _initTile: function(t) {
            ...
            t.style.width = i.x + "px", t.style.height = i.y + "px", t.onselectstart = u1, t.onmousemove = u1, P.ielt9 && this.options.opacity < 1 && C(t, this.options.opacity);
        },
        _addTile: function(t, i) {
            var e = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), a1(this._tileReady, this, t));
            this._initTile(o), this.createTile.length < 2 && x(a1(this._tileReady, this, t, null, o)), Z(o, e), this._tiles[n] = {
                el: o,
                coords: t,
                current: !0
        ...
        _tileReady: function(t, i, e) {
            ...
            (e = this._tiles[n]) && (e.loaded = +new Date, this._map._fadeAnimated ? (C(e.el, 0), r1(this._fadeFrame), this._fadeFrame = x(this._updateOpacity, this)) : (e.active = !0, this._pruneTiles()), i || (z(e.el, "leaflet-tile-loaded"), this.fire("tileload", {
                tile: e.el,
                coords: t
            })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), P.ielt9 || !this._map._fadeAnimated ? x(this._pruneTiles, this) : setTimeout(a1(this._pruneTiles, this), 250)));
        },
        _getTilePos: function(t) {
            return t.scaleBy(this.getTileSize()).subtract(this._level.origin);
        },
        _wrapCoords: function(t) {
            var i = new p1(this._wrapX ? H(t.x, this._wrapX) : t.x, this._wrapY ? H(t.y, this._wrapY) : t.y);
            return i.z = t.z, i;
        },
        _pxBoundsToTileRange: function(t) {
            var i = this.getTileSize();
            return new m1(t.min.unscaleBy(i).floor(), t.max.unscaleBy(i).ceil().subtract([
                1,
                1
            ]));
        },
    ...
    var Ie = Ae.extend({
        ...
        initialize: function(t, i) {
            this._url = t, (i = c1(this, i)).detectRetina && P.retina && 0 < i.maxZoom && (i.tileSize = Math.floor(i.tileSize / 2), i.zoomReverse ? (i.zoomOffset--, i.minZoom++) : (i.zoomOffset++, i.maxZoom--), i.minZoom = Math.max(0, i.minZoom)), "string" == typeof i.subdomains && (i.subdomains = i.subdomains.split("")), this.on("tileunload", this._onTileRemove);
        },
        setUrl: function(t, i) {
        ...
        createTile: function(t, i) {
            ...
            return S(e, "load", a1(this._tileOnLoad, this, i, e)), S(e, "error", a1(this._tileOnError, this, i, e)), !this.options.crossOrigin && "" !== this.options.crossOrigin || (e.crossOrigin = !0 === this.options.crossOrigin ? "" : this.options.crossOrigin), "string" == typeof this.options.referrerPolicy && (e.referrerPolicy = this.options.referrerPolicy), e.alt = "", e.setAttribute("role", "presentation"), e.src = this.getTileUrl(t), e;
        },
        getTileUrl: function(t) {
            ...
            return this._map && !this._map.options.crs.infinite && (t = this._globalTileRange.max.y - t.y, this.options.tms && (i.y = t), i["-y"] = t), q(this._url, l1(i, this.options));
        },
        _tileOnLoad: function(t, i) {
            P.ielt9 ? setTimeout(a1(t, this, null, i), 0) : t(null, i);
        },
        ...
        _abortLoading: function() {
            var t, i, e;
            for(t in this._tiles)this._tiles[t].coords.z !== this._tileZoom && ((e = this._tiles[t].el).onload = u1, e.onerror = u1, e.complete || (e.src = K, i = this._tiles[t].coords, T(e), delete this._tiles[t], this.fire("tileabort", {
                tile: e,
                coords: i
            })));
        },
    ...
    var Re = Ie.extend({
        ...
        initialize: function(t, i) {
            this._url = t;
            var e, n = l1({}, this.defaultWmsParams);
            for(e in i)e in this.options || (n[e] = i[e]);
            var t = (i = c1(this, i)).detectRetina && P.retina ? 2 : 1, o = this.getTileSize();
        ...
        getTileUrl: function(t) {
            var i = this._tileCoordsToNwSe(t), e = this._crs, e = f1(e.project(i[0]), e.project(i[1])), i = e.min, e = e.max, i = (1.3 <= this._wmsVersion && this._crs === re ? [
                i.y,
                i.x,
                e.y,
                e.x
    ...
    var Ne = o1.extend({
        ...
        initialize: function(t) {
            c1(this, t), h1(this), this._layers = this._layers || {};
        },
        onAdd: function() {
        ...
        _updateTransform: function(t, i) {
            var e = this._map.getZoomScale(i, this._zoom), n = this._map.getSize().multiplyBy(.5 + this.options.padding), o = this._map.project(this._center, i), n = n.multiplyBy(-e).add(o).subtract(this._map._getNewPixelOrigin(t, i));
        ...
        _update: function() {
            ...
            this._bounds = new m1(e, e.add(i.multiplyBy(1 + 2 * t)).round()), this._center = this._map.getCenter(), this._zoom = this._map.getZoom();
        }
    }), De = Ne.extend({
        options: {
            tolerance: 0
        ...
        _destroyContainer: function() {
            r1(this._redrawRequest), delete this._ctx, T(this._container), E(this._container), delete this._container;
        },
        _updatePaths: function() {
        ...
        _removePath: function(t) {
            ...
            e ? e.prev = i : this._drawLast = i, i ? i.next = e : this._drawFirst = e, delete t._order, delete this._layers[h1(t)], this._requestRedraw(t);
        },
        ...
        _extendRedrawBounds: function(t) {
            var i;
            t._pxBounds && (i = (t.options.weight || 0) + 1, this._redrawBounds = this._redrawBounds || new m1, this._redrawBounds.extend(t._pxBounds.min.subtract([
                i,
                i
        ...
        _handleMouseOut: function(t) {
            ...
            i && (M(this._container, "leaflet-interactive"), this._fireEvent([
                i
        ...
        _handleMouseHover: function(t, i) {
            if (!this._mouseHoverThrottled) {
                ...
                n !== this._hoveredLayer && (this._handleMouseOut(t), n && (z(this._container, "leaflet-interactive"), this._fireEvent([
                    n
                ], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(!!this._hoveredLayer && [
                    this._hoveredLayer
                ], t), this._mouseHoverThrottled = !0, setTimeout(a1(function() {
    ...
    var He = function() {
        ...
        _initPath: function(t) {
            ...
            z(i, "leaflet-vml-shape " + (this.options.className || "")), i.coordsize = "1 1", t._path = He("path"), i.appendChild(t._path), this._updateStyle(t), this._layers[h1(t)] = t;
        },
        _addPath: function(t) {
            var i = t._container;
        ...
        _removePath: function(t) {
            var i = t._container;
            T(i), t.removeInteractiveTarget(i), delete this._layers[h1(t)];
        },
        _updateStyle: function(t) {
            var i = t._stroke, e = t._fill, n = t.options, o = t._container;
            o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (i = i || (t._stroke = He("stroke")), o.appendChild(i), i.weight = n.weight + "px", i.color = n.color, i.opacity = n.opacity, n.dashArray ? i.dashStyle = d1(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : i.dashStyle = "", i.endcap = n.lineCap.replace("butt", "flat"), i.joinstyle = n.lineJoin) : i && (o.removeChild(i), t._stroke = null), n.fill ? (e = e || (t._fill = He("fill")), o.appendChild(e), e.color = n.fillColor || n.color, e.opacity = n.fillOpacity) : e && (o.removeChild(e), t._fill = null);
        },
        _updateCircle: function(t) {
        ...
        _update: function() {
            var t, i, e;
            this._map._animatingZoom && this._bounds || (Ne.prototype._update.call(this), i = (t = this._bounds).getSize(), e = this._container, this._svgSize && this._svgSize.equals(i) || (this._svgSize = i, e.setAttribute("width", i.x), e.setAttribute("height", i.y)), Z(e, t.min), e.setAttribute("viewBox", [
                t.min.x,
                t.min.y,
                i.x,
                i.y
        ...
        _initPath: function(t) {
            ...
            t.options.className && z(i, t.options.className), t.options.interactive && z(i, "leaflet-interactive"), this._updateStyle(t), this._layers[h1(t)] = t;
        },
        _addPath: function(t) {
            this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
        },
        _removePath: function(t) {
            T(t._path), t.removeInteractiveTarget(t._path), delete this._layers[h1(t)];
        },
        _updatePath: function(t) {
            t._project(), t._update();
        },
        _updateStyle: function(t) {
            var i = t._path, t = t.options;
        ...
        _updateCircle: function(t) {
            var i = t._point, e = Math.max(Math.round(t._radius), 1), n = "a" + e + "," + (Math.max(Math.round(t._radiusY), 1) || e) + " 0 1,0 ", i = t._empty() ? "M0 0" : "M" + (i.x - e) + "," + i.y + n + 2 * e + ",0 " + n + 2 * -e + ",0 ";
            this._setPath(t, i);
        },
        _setPath: function(t, i) {
    ...
    var _t = n1.extend({
        ...
        _onMouseMove: function(t) {
            ...
            var t = new m1(this._point, this._startPoint), i = t.getSize();
        ...
        _onMouseUp: function(t) {
            1 !== t.which && 1 !== t.button || (this._finish(), this._moved && (this._clearDeferredResetState(), this._resetStateTimeout = setTimeout(a1(this._resetState, this), 0), t = new s1(this._map.containerPointToLatLng(this._startPoint), this._map.containerPointToLatLng(this._point)), this._map.fitBounds(t).fire("boxzoomend", {
                boxZoomBounds: t
            })));
        },
        ...
        _onDoubleClick: function(t) {
            var i = this._map, e = i.getZoom(), n = i.options.zoomDelta, e = t.originalEvent.shiftKey ? e - n : e + n;
        ...
        _onDragStart: function() {
            var t, i = this._map;
            i._stop(), this._map.options.maxBounds && this._map.options.maxBoundsViscosity ? (t = g1(this._map.options.maxBounds), this._offsetLimit = f1(this._map.latLngToContainerPoint(t.getNorthWest()).multiplyBy(-1), this._map.latLngToContainerPoint(t.getSouthEast()).multiplyBy(-1).add(this._map.getSize())), this._viscosity = Math.min(1, Math.max(0, this._map.options.maxBoundsViscosity))) : this._offsetLimit = null, i.fire("movestart").fire("dragstart"), i.options.inertia && (this._positions = [], this._times = []);
        },
        _onDrag: function(t) {
            var i, e;
        ...
        _onZoomEnd: function() {
            var t = this._map.getSize().divideBy(2), i = this._map.latLngToLayerPoint([
                0,
                0
            ]);
        ...
        _onPreDragWrap: function() {
            var t = this._worldWidth, i = Math.round(t / 2), e = this._initialWorldOffset, n = this._draggable._newPos.x, o = (n - i + e) % t + i - e, n = (n + i + e) % t - i - e, t = Math.abs(o + e) < Math.abs(n + e) ? o : n;
        ...
        _onDragEnd: function(t) {
            ...
            s.fire("dragend", t), a ? s.fire("moveend") : (this._prunePositions(+new Date), t = this._lastPos.subtract(this._positions[0]), a = (this._lastTime - this._times[0]) / 1e3, i = r.easeLinearity, a = (t = t.multiplyBy(i / a)).distanceTo([
                0,
                0
            ]), e = Math.min(r.inertiaMaxSpeed, a), t = t.multiplyBy(e / a), n = e / (r.inertiaDeceleration * i), (o = t.multiplyBy(-n / 2).round()).x || o.y ? (o = s._limitOffset(o, s.options.maxBounds), x(function() {
                s.panBy(o, {
                    duration: n,
                    easeLinearity: i,
                    noMoveStart: !0,
        ...
        _setPanDelta: function(t) {
            for(var i = this._panKeys = {}, e = this.keyCodes, n = 0, o = e.left.length; n < o; n++)i[e.left[n]] = [
                -1 * t,
                0
            ];
            for(n = 0, o = e.right.length; n < o; n++)i[e.right[n]] = [
                t,
                0
            ];
            for(n = 0, o = e.down.length; n < o; n++)i[e.down[n]] = [
                0,
                t
            ];
            for(n = 0, o = e.up.length; n < o; n++)i[e.up[n]] = [
                0,
                -1 * t
            ];
        },
        ...
        _onKeyDown: function(t) {
            if (!(t.altKey || t.ctrlKey || t.metaKey)) {
                ...
                if (e in this._panKeys) n._panAnim && n._panAnim._inProgress || (i = this._panKeys[e], t.shiftKey && (i = _1(i).multiplyBy(3)), n.panBy(i), n.options.maxBounds && n.panInsideBounds(n.options.maxBounds));
        ...
        _onWheelScroll: function(t) {
            var i = ji(t), e = this._map.options.wheelDebounceTime, i = (this._delta += i, this._lastMousePos = this._map.mouseEventToContainerPoint(t), this._startTime || (this._startTime = +new Date), Math.max(e - (+new Date - this._startTime), 0));
            clearTimeout(this._timer), this._timer = setTimeout(a1(this._performZoom, this), i), Ri(t);
        },
        _performZoom: function() {
            var t = this._map, i = t.getZoom(), e = this._map.options.zoomSnap || 0, n = (t._stop(), this._delta / (4 * this._map.options.wheelPxPerZoomLevel)), n = 4 * Math.log(2 / (1 + Math.exp(-Math.abs(n)))) / Math.LN2, e = e ? Math.ceil(n / e) * e : n, n = t._limitZoom(i + (0 < this._delta ? e : -e)) - i;
        ...
        _onDown: function(t) {
            var i;
            clearTimeout(this._holdTimeout), 1 === t.touches.length && (i = t.touches[0], this._startPos = this._newPos = new p1(i.clientX, i.clientY), this._holdTimeout = setTimeout(a1(function() {
        ...
        _onMove: function(t) {
            t = t.touches[0];
            this._newPos = new p1(t.clientX, t.clientY);
        },
        ...
        _onTouchMove: function(t) {
            if (t.touches && 2 === t.touches.length && this._zooming) {
                ...
                this._moved || (i._moveStart(!0, !1), this._moved = !0), r1(this._animRequest);
                n = a1(i._move, i, this._center, this._zoom, {
                    pinch: !0,
                    round: !1
                });
        ...
        _onTouchEnd: function() {
            this._moved && this._zooming ? (this._zooming = !1, r1(this._animRequest), E(document, "touchmove", this._onTouchMove, this), E(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom))) : this._zooming = !1;
        }
    })), qe = (A.addInitHook("addHandler", "touchZoom", Bt), A.BoxZoom = _t, A.DoubleClickZoom = Ct, A.Drag = Zt, A.Keyboard = St, A.ScrollWheelZoom = kt, A.TapHold = Et, A.TouchZoom = Bt, t1.Bounds = m1, t1.Browser = P, t1.CRS = ot, t1.Canvas = De, t1.Circle = me, t1.CircleMarker = pe, t1.Class = it, t1.Control = I, t1.DivIcon = Be, t1.DivOverlay = O, t1.DomEvent = mt, t1.DomUtil = pt, t1.Draggable = Xi, t1.Evented = et, t1.FeatureGroup = he, t1.GeoJSON = ve, t1.GridLayer = Ae, t1.Handler = n1, t1.Icon = le, t1.ImageOverlay = Ce, t1.LatLng = v1, t1.LatLngBounds = s1, t1.Layer = o1, t1.LayerGroup = ae, t1.LineUtil = gt, t1.Map = A, t1.Marker = de, t1.Mixin = ft, t1.Path = _e, t1.Point = p1, t1.PolyUtil = vt, t1.Polygon = ge, t1.Polyline = fe, t1.Popup = ke, t1.PosAnimation = Wi, t1.Projection = wt, t1.Rectangle = Ve, t1.Renderer = Ne, t1.SVG = Fe, t1.SVGOverlay = Se, t1.TileLayer = Ie, t1.Tooltip = Ee, t1.Transformation = at, t1.Util = tt, t1.VideoOverlay = Ze, t1.bind = a1, t1.bounds = f1, t1.canvas = je, t1.circle = function(t, i, e) {
        return new me(t, i, e);
    }, t1.circleMarker = function(t, i) {
        return new pe(t, i);
    }, t1.control = Fi, t1.divIcon = function(t) {
        return new Be(t);
    }, t1.extend = l1, t1.featureGroup = function(t, i) {
        return new he(t, i);
    }, t1.geoJSON = Me, t1.geoJson = zt, t1.gridLayer = function(t) {
        return new Ae(t);
    }, t1.icon = function(t) {
        return new le(t);
    }, t1.imageOverlay = function(t, i, e) {
        return new Ce(t, i, e);
    }, t1.latLng = w, t1.latLngBounds = g1, t1.layerGroup = function(t, i) {
        return new ae(t, i);
    }, t1.map = function(t, i) {
        return new A(t, i);
    }, t1.marker = function(t, i) {
        return new de(t, i);
    }, t1.point = _1, t1.polygon = function(t, i) {
        return new ge(t, i);
    }, t1.polyline = function(t, i) {
        return new fe(t, i);
    }, t1.popup = function(t, i) {
        return new ke(t, i);
    }, t1.rectangle = function(t, i) {
        return new Ve(t, i);
    }, t1.setOptions = c1, t1.stamp = h1, t1.svg = Ue, t1.svgOverlay = function(t, i, e) {
        return new Se(t, i, e);
    }, t1.tileLayer = Oe, t1.tooltip = function(t, i) {
        return new Ee(t, i);
    }, t1.transformation = ht, t1.version = "1.8.0", t1.videoOverlay = function(t, i, e) {
        return new Ze(t, i, e);
    }, window.L);
    t1.noConflict = function() {
        return window.L = qe, this;
    }, window.L = t1;
});

//# sourceMappingURL=index.f9530a4d.js.map
