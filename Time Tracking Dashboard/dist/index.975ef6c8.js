...
var _dataJson = require("../src/data.json");
...
function SetTimes(timeButton) {
    for(var i = 0; i < 6; i++){
        ...
        let currenttime = (0, _dataJsonDefault.default)[i].timeframes[timeButton].current;
        let lasttime = (0, _dataJsonDefault.default)[i].timeframes[timeButton].previous;
        //Load divs
...
},{"../src/data.json":"aLYkf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aLYkf":[function(require,module,exports) {
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire81ee")
